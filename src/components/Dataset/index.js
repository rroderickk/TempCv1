...
{ assets: 
  ...
  },
  {
    ...
    idENG: "Describe the concept of Scope in JS Identify the use of Local Scope, Function Scope and Block Scope, Describe the concept of Closure in JavaScript Understand the concept of Lexical Scope",
  ...
  },
  {
    ...
    name: "Effective time management", token_id: "8", traits: [9], image_original_url: tiempo,
